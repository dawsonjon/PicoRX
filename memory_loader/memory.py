...
mem.add(channel_to_words("20m SSTV        ", 14230000, 14101000, 14350000, "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("40m SSTV        ", 7033000,  7060000,  7200000,  "LSB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("80m SSTV        ", 3845000,  3620000,  3800000,  "LSB", "SLOW", "100Hz", "Normal"))
...
mem.add(channel_to_words("20m FT4         ", 14080000, 14070000, 14099000, "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("30m FT4         ", 10140000, 10130000, 10150000, "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("40m FT4         ", 7047500,  7040000,  7060000,  "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("80m FT4         ", 3575000,  3570000,  3600000,  "USB", "SLOW", "100Hz", "Normal"))
...
mem.add(channel_to_words("NAVTEX NATIONAL ", 490000,  3570000,  3600000,  "LSB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("NAVTEX GLOBAL   ", 518000,  3570000,  3600000,  "LSB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("GYA WEAFAX 1    ", 2616600,  2616600,  2616600,  "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("GYA WEAFAX 2    ", 4608100,  4608100,  4608100,  "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("GYA WEAFAX 3    ", 8038100,  8038100,  8038100,  "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("GYA WEAFAX 4    ", 11084600,  14434100,  14434100,  "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("DWD WEAFAX 1    ", 3853100,  18259100,  18259100,  "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("DWD WEAFAX 2    ", 7878100,  18259100,  18259100,  "USB", "SLOW", "100Hz", "Normal"))
mem.add(channel_to_words("DWD WEAFAX 3    ", 13880600,  18259100,  18259100,  "USB", "SLOW", "100Hz", "Normal"))
