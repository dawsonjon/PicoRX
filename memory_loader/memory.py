...
mem.add(channel_to_words("10m CW          ", 28000000, 28000000, 28070000, "USB", "SLOW", "500Hz", "Normal"))
mem.add(channel_to_words("12m CW          ", 24890000, 24890000, 24915000, "USB", "SLOW", "500Hz", "Normal"))
mem.add(channel_to_words("15m CW          ", 21000000, 21000000, 21070000, "USB", "SLOW", "500Hz", "Normal"))
mem.add(channel_to_words("17m CW          ", 18068000, 18068000, 18095000, "USB", "SLOW", "500Hz", "Normal"))
mem.add(channel_to_words("20m CW          ", 14000000, 14000000, 14099000, "USB", "SLOW", "500Hz", "Normal"))
mem.add(channel_to_words("30m CW          ", 10100000, 10100000, 10130000, "USB", "SLOW", "500Hz", "Normal"))
mem.add(channel_to_words("40m CW          ", 7000000,  7000000,  7060000,  "USB", "SLOW", "500Hz", "Normal"))
mem.add(channel_to_words("80m CW          ", 3500000,  3500000,  3620000,  "USB", "SLOW", "500Hz", "Normal"))
mem.add(channel_to_words("160m CW         ", 1810000,  1810000,  1843000,  "USB", "SLOW", "500Hz", "Normal"))
