...
const uint32_t step_sizes[13] = {10,   50,    100,   500,   1000,  5000,  6250,
                                 9000, 10000, 12500, 25000, 50000, 100000};
const char steps[13][8] = {"10Hz", "50Hz",  "100Hz",   "500Hz", "1kHz",  "5kHz",  "6.25kHz",
                           "9kHz", "10kHz", "12.5kHz", "25kHz", "50kHz", "100kHz"};
