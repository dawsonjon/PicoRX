...
class quad_si5351
{
  ...
  void adjust_phase(uint8_t synth, uint32_t a, uint32_t b, uint32_t c, uint8_t rDiv,
                    uint32_t delay_us);
...
public:
  bool initialise(i2c_inst_t* i2c, uint8_t sda_pin, uint8_t scl_pin, uint8_t address,
