...
////////////////////////////////////////////////////////////////////////////////
void ui::renderpage_bigspectrum(bool tuned, rx_status & status, rx & receiver)
{
  display_clear();
  draw_slim_status(0, status, receiver);
  draw_h_tick_marks(8);
  draw_spectrum(13, 63, tuned);
  display_show();
}
...
////////////////////////////////////////////////////////////////////////////////
void ui::renderpage_combinedspectrum(bool view_changed, bool tuned, rx_status & status, rx & receiver)
{
...
////////////////////////////////////////////////////////////////////////////////
void ui::draw_spectrum(uint16_t startY, uint16_t endY, bool tuned)
{
  ...
  if(settings.global.spectrum_hold && tuned)
  {
...
void ui::do_ui(bool tuned)
{
    ...
    else if(ui_state == idle)
    {
      ...
      switch(settings.global.view)
      {
        ...
        case 1: renderpage_bigspectrum(tuned, status, receiver);break;
        case 2: renderpage_combinedspectrum(view_changed, tuned, status, receiver);break;
