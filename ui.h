...
class ui
{
  ...
  void renderpage_bigspectrum(bool tuned, rx_status & status, rx & receiver);
  void renderpage_oscilloscope(rx_status & status, rx & receiver);
  void renderpage_combinedspectrum(bool view_changed, bool tuned, rx_status & status, rx & receiver);
  ...
  void draw_spectrum(uint16_t startY, uint16_t endY, bool tuned);
